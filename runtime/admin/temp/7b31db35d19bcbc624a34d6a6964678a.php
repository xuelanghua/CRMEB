<?php /*a:6:{s:58:"E:\project\tpshop\app\admin\view\article\article\index.php";i:1567990147;s:53:"E:\project\tpshop\app\admin\view\public\container.php";i:1567990147;s:54:"E:\project\tpshop\app\admin\view\public\frame_head.php";i:1567990147;s:49:"E:\project\tpshop\app\admin\view\public\style.php";i:1568192923;s:54:"E:\project\tpshop\app\admin\view\public\inner_page.php";i:1567990148;s:56:"E:\project\tpshop\app\admin\view\public\frame_footer.php";i:1567990147;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
      	...
      	<div class="ibox">
            ...
            <ul  class="folder-list m-b-md">
              	<?php if(is_array($tree) || $tree instanceof \think\Collection || $tree instanceof \think\Paginator): $i = 0; $__LIST__ = $tree;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                   <li class="p-xxs"><a href="<?php echo Url('article.article/index',array('pid'=>$vo['id'])); ?>"><?php echo htmlentities(str_repeat('.....',$vo['level'])); ?><?php echo htmlentities($vo['title']); ?></a></li>
                ...
                <table class="footable table table-striped  table-bordered " data-page-size="20">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <button class="btn btn-warning btn-xs del_news_one" data-id="<?php echo htmlentities($vo['id']); ?>" type="button" data-url="<?php echo Url('delete',array('id'=>$vo['id'])); ?>" ><i class="fa fa-warning"></i> 删除
